//Form JS File
function addWidgetsfrmSegDictionary() {
    ...
    var segDictionarybox = new kony.ui.FlexContainer({
        "id": "segDictionarybox",
        "isVisible": true,
        "orientation": null,
        "width": "100%",
    ...
    var segDictionary = new kony.ui.SegmentedUI2({
        "id": "segDictionary",
        "top": "10%",
        "left": "0dp",
        "width": "100%",
    ...
    frmSegDictionary.add(FlexContainer09ba3e0b3fa634a, Label0999382505cd447, segDictionary, FlexContainer0e378e636d6c142);
    frmSegDictionary.setDefaultUnit(kony.flex.DP);
};

function frmSegDictionaryGlobals() {
    var MenuId = [];
    frmSegDictionary = new kony.ui.Form2({
        "id": "frmSegDictionary",
        ...
        "skin": "frmBGColrSkin",
        "layoutType": kony.flex.FREE_FORM,
        "addWidgets": addWidgetsfrmSegDictionary
    }, {
        "padding": [0, 0, 0, 0],
