...
function buttonContext2() {
    frmButtonContext.segBtnContext.widgetDataMap = {
        imgProd: "imgProd",
    ...
    var masterTable = [{
        imgProd: "img1.png",
        lblProdName: "Food Item 1",
        lblProdPrice: "$12.23",
        btnProd: "View Prod"
    }, {
        imgProd: "img2.png",
        lblProdName: "Food Item 2",
        lblProdPrice: "$11.13",
        btnProd: "View Prod"
    }, {
        imgProd: "img3.png",
        lblProdName: "Food Item 3",
        lblProdPrice: "$12.21",
        btnProd: "View Prod"
    }, {
        imgProd: "img1.png",
        lblProdName: "Food Item 4",
        lblProdPrice: "$14.22",
        btnProd: "View Prod"
    }, {
        imgProd: "img2.png",
        lblProdName: "Food Item 5",
        lblProdPrice: "$15.24",
        btnProd: "View Prod"
    }, {
        imgProd: "img3.png",
        lblProdName: "Food Item 6",
        lblProdPrice: "$16.13",
        btnProd: "View Prod"
    }];
...
/*
 * This function used on Button click to get the context of selected record
 * Written By :Mohammad Jabiulla
 */
function getProdContext2(context) {
...
/*
 * This function used to close/hide the flex popup
 * Written By :Mohammad Jabiulla
 */
 ...
 * Written By :Mohammad Jabiulla
 */
function recordWithTwoItems2() {
    frmOneRowTwoItems.segRowItems.widgetDataMap = {
        imgProd1: "imgProd1",
 ...
 * Written By :Mohammad Jabiulla
 */
function segButtonContextEvent22(eventobject, context) {
...
function editSegmentData2() {
    frmSegRowEdit.segEdit.widgetDataMap = {
        img: "img",
        lbl: "lbl"
    };
    editSegData = [{
        ...
        lbl: "Segment Record data1"
    }, {
        img: {
            src: "check_btn.png"
        },
        lbl: "Segment Record data2"
    }, {
        img: {
            src: "check_btn.png"
        },
        lbl: "Segment Record data3"
    }, {
        img: {
            src: "check_btn.png"
        },
        lbl: "Segment Record data4"
    }, {
        img: {
            src: "check_btn.png"
        },
        lbl: "Segment Record data5"
    }, {
        img: {
            src: "check_btn.png"
        },
        lbl: "Segment Record data6"
    }, {
        img: {
            src: "check_btn.png"
        },
        lbl: "Segment Record data7"
    }, {
        img: {
            src: "check_btn.png"
        },
        lbl: "Segment Record data8"
    }];
    frmSegRowEdit.segEdit.setData(editSegData);
}
/*
 * This function used to edit the selected record details
 * Written By :Mohammad Jabiulla
 */
function editSelectedRecord2() {
...
function CandESegmentData2() {
    frmSegColAndExp.segColExp.widgetDataMap = {
        imgProd: "imgProd",
        lblProdName: "lblProdName",
        lblProdPrice: "lblProdPrice",
        btnProd: "btnProd",
    ...
    ceTable = [{
        ...
        lblProdPrice: "$12.23",
        btnProd: "View Prod",
        prodDescription: "Eggs boiled and roasted in masala gravy in Tomato and spices; served with Basmati Rice",
        flxProdDesc: {
            isVisible: false
        }
    }, {
...
/*
 * This function used to show the selected record hidden details
 * Written By :Mohammad Jabiulla
 */
function showHiddenDescription2(context) {
    var rowIndex = context.rowIndex;
    for (var i = 0; i < ceTable.length; i++) {
        if (i == rowIndex) {
            if (ceTable[i]["flxProdDesc"]["isVisible"] == false) {
                ceTable[i]["flxProdDesc"] = {
                    isVisible: true
                }
 ...
 * Written By :Mohammad Jabiulla
 */
function GestureSegmentData2() {
    frmSegGestures.segGestures.widgetDataMap = {
        img: "img",
        lbl: "lbl"
    };
    var editSegData = [{
...
/*
 * This function used to set the Gesture on rowTemplate
 * Written By :Mohammad Jabiulla
 */
function GenericGestureHandler2() {
    rowEditSeg.setGestureRecognizer(1, {
        fingers: 1,
        taps: 2
    }, onGestureFunction); //double tap gesture
    rowEditSeg.setGestureRecognizer(2, {
        fingers: 1,
        swipedistance: 50,
        swipevelocity: 75
    }, onGestureFunction); // swipe with default parameters
    rowEditSeg.setGestureRecognizer(3, {
        pressDuration: 2
 ...
 * Written By :Mohammad Jabiulla
 */
function onGestureFunction2(commonWidget, gestureInfo, context) {
    ...
    if ((GesType == "1")) {
        kony.ui.Alert("Double tap gesture", null, "Information", "Yes", "No", "Info", null);
    } else if ((GesType == "2")) {
        ...
        kony.ui.Alert(direction + "Swipe gesture", null, "Information", "Yes", "No", "Info", null);
    } else if ((GesType == "3")) {
        kony.ui.Alert("Longpress tap gesture", null, "Information", "Yes", "No", "Info", null);
    }
}